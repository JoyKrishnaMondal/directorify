...
(function(){
  var browserify, fs, color, chokidar, delimit, ref$, ShowList, CopyDefaults, minDefaults, SeparateFilesAndDir, lo, colors, pathResolve, ErrorMain, log, isDirectory, Compile, Main, isString, isNumber, AssumedDir, Defaults, InputLen, ConfigFile, Options;
