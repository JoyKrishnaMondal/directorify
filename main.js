...
(function(){
  var browserify, fs, color, chokidar, delimit, ref$, ShowList, CopyDefaults, minDefault, SeparateFilesAndDir, lo, colors, pathResolve, ErrorMain, log, isDirectory, Compile, Main, isString, isNumber, AssumedDir, Defaults, InputLen, ConfigFile, Options;
  browserify = require("browserify");
  fs = require("fs");
  color = require("colors/safe");
  chokidar = require("chokidar");
  delimit = require('path').sep;
  ref$ = require("node-helpers"), ShowList = ref$.ShowList, CopyDefaults = ref$.CopyDefaults, minDefault = ref$.minDefault;
